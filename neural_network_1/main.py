...
# Zapisywanie modelu w głównym katalogu projektu
# Format H5 (pojedynczy plik)
model_path_h5 = "chess_pieces_model.h5"
model.save(model_path_h5)

# Format SavedModel (katalog z pełną specyfikacją modelu)
model_path_saved = "chess_pieces_model_saved.keras"
model.save(model_path_saved)

print(f"Zapisano model do pliku: {model_path_h5}")
print(f"Zapisano model w formacie SavedModel: {model_path_saved}")